  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul className="navbar-nav  mb-2 mb-lg-0 p-2">
      ...
      <li className="nav-item pl-5 fontfamilycls">
        <NavLink className="nav-link active" aria-current="page" to="#"><h5>Products</h5></NavLink>
      </li>
      <li className="nav-item pl-5 fontfamilycls">
        <NavLink className="nav-link active" aria-current="page" to="#"><h5>Contact</h5></NavLink>
      </li>
      <li className="nav-item pl-5 fontfamilycls">
        <NavLink className="nav-link active" aria-current="page" to="#"><h5>AboutUs</h5></NavLink>
      </li>
      
    </ul>  
  </div>
  
  <SearchIcon className="ssmargin"/>
